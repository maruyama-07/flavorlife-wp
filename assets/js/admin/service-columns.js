(function() {
    ...
    tinymce.PluginManager.add('service_columns', function(editor, url) {
        editor.addButton('service_columns', {
            text: 'サービス2カラム',
            icon: false,
            onclick: function() {
                if (typeof wp === 'undefined' || !wp.media) {
                    ...
                    openMediaPicker(function(id2) {
                        ...
                        editor.windowManager.open({
                            ...
                            onsubmit: function(e) {
                                ...
                                var content = '[service_columns ' + attrs.join(' ') + ']';
