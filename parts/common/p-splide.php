        ...
        <div class="splide__list">
            ...
            <<?php echo $tag . $href; ?> class="splide__slide">
                ...
                <div class="splide__slide-text">
                    <p><?php echo function_exists('tool_acf_format_field_for_echo') ? tool_acf_format_field_for_echo((string) $slide_text) : (function_exists('tool_format_text_with_sp_break') ? tool_format_text_with_sp_break((string) $slide_text) : nl2br(esc_html((string) $slide_text))); ?></p>
                </div>
                <?php endif; ?>
            </<?php echo $tag; ?>>
                        <?php
